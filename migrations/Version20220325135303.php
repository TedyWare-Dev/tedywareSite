 ...
 */
final class Version20220325135303 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD category_id INT NOT NULL, DROP categorie');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE article ADD categorie VARCHAR(255) NOT NULL, DROP category_id');
    }
}
